...
static void test_lookup_with_dividend(void) {
    ...
    assert(q.has_conversion_rate_eur == 0);
    assert(almost_equal(q.conversion_rate_eur, 0.0));
...
static void test_lookup_dividend_unavailable_non_error(void) {
    const char *json =
        "{\"chart\":{\"result\":[{\"meta\":{\"currency\":\"USD\"},\"timestamp\":[1710460800],"
...
static void test_lookup_dividend_not_requested(void) {
    const char *json =
        "{\"chart\":{\"result\":[{\"meta\":{\"currency\":\"USD\"},\"timestamp\":[1710720000],"
...
static void test_lookup_not_found_when_close_null(void) {
    const char *json =
        "{\"chart\":{\"result\":[{\"meta\":{\"currency\":\"USD\"},\"timestamp\":[1710806400],"
...
static void test_lookup_invalid_args(void) {
    const char *json =
        "{\"chart\":{\"result\":[{\"meta\":{\"currency\":\"USD\"},\"timestamp\":[1710892800],"
