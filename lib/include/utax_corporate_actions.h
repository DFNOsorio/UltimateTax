 ...
 * @param out_action_id Optional output for inserted row id.
 ...
 * @param db Open database handle.
 * @param action_id Primary key of the row to update.
 ...
 * @param db Open database handle.
 * @param action_id Primary key of the row to delete.
 * @return @ref UTAX_OK on success, otherwise an error code.
 */
